...
import * as ɵngcc1 from '@nativescript/core';
import * as ɵngcc2 from '@angular/common';
import * as ɵngcc3 from '@angular/animations/browser';
import * as ɵngcc4 from '@angular/common/http';
import * as ɵngcc5 from '@angular/router';

const _c0 = ["loader"];
const _c1 = ["*"];
function AndroidFilterComponent_ng_content_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵprojection(0, 0, ["*ngIf", "show"]);
} }
function IosFilterComponent_ng_content_0_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵprojection(0, 0, ["*ngIf", "show"]);
} }
...
NSFileSystem.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NSFileSystem, factory: NSFileSystem.ɵfac });
...
FileSystemResourceLoader.ɵfac = function FileSystemResourceLoader_Factory(t) { return new (t || FileSystemResourceLoader)(ɵngcc0.ɵɵinject(NSFileSystem)); };
FileSystemResourceLoader.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: FileSystemResourceLoader, factory: FileSystemResourceLoader.ɵfac });
...
NSLocationStrategy.ɵfac = function NSLocationStrategy_Factory(t) { return new (t || NSLocationStrategy)(ɵngcc0.ɵɵinject(FrameService)); };
...
ModalDialogService.ɵfac = function ModalDialogService_Factory(t) { return new (t || ModalDialogService)(ɵngcc0.ɵɵinject(NSLocationStrategy)); };
ModalDialogService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ModalDialogService, factory: ModalDialogService.ɵfac });
...
TemplatedItemsComponent.ɵfac = function TemplatedItemsComponent_Factory(t) { return new (t || TemplatedItemsComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.IterableDiffers)); };
TemplatedItemsComponent.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TemplatedItemsComponent, contentQueries: function TemplatedItemsComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, TemplateRef, true, TemplateRef);
    } if (rf & 2) {
        let _t;
...
TemplateKeyDirective.ɵfac = function TemplateKeyDirective_Factory(t) { return new (t || TemplateKeyDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(TEMPLATED_ITEMS_COMPONENT, 1)); };
...
ListViewComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ListViewComponent, selectors: [["ListView"]], features: [ɵngcc0.ɵɵProvidersFeature([{ provide: TEMPLATED_ITEMS_COMPONENT, useExisting: forwardRef(() => ListViewComponent) }]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 3, vars: 0, consts: [["loader", ""]], template: function ListViewComponent_Template(rf, ctx) { if (rf & 1) {
...
ActionBarComponent.ɵfac = function ActionBarComponent_Factory(t) { return new (t || ActionBarComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Page)); };
ActionBarComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ActionBarComponent, selectors: [["ActionBar"]], ngContentSelectors: _c1, decls: 1, vars: 0, template: function ActionBarComponent_Template(rf, ctx) { if (rf & 1) {
...
ActionBarScope.ɵfac = function ActionBarScope_Factory(t) { return new (t || ActionBarScope)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Page)); };
ActionBarScope.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ActionBarScope, selectors: [["ActionBarExtension"]], decls: 0, vars: 0, template: function ActionBarScope_Template(rf, ctx) { }, encapsulation: 2 });
...
ActionItemDirective.ɵfac = function ActionItemDirective_Factory(t) { return new (t || ActionItemDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ActionBarScope, 8)); };
ActionItemDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ActionItemDirective, selectors: [["ActionItem"]] });
...
NavigationButtonDirective.ɵfac = function NavigationButtonDirective_Factory(t) { return new (t || NavigationButtonDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ActionBarScope, 8)); };
NavigationButtonDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: NavigationButtonDirective, selectors: [["NavigationButton"]] });
...
AndroidFilterComponent.ɵfac = function AndroidFilterComponent_Factory(t) { return new (t || AndroidFilterComponent)(); };
AndroidFilterComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: AndroidFilterComponent, selectors: [["android"]], ngContentSelectors: _c1, decls: 1, vars: 1, consts: [[4, "ngIf"]], template: function AndroidFilterComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵtemplate(0, AndroidFilterComponent_ng_content_0_Template, 1, 0, "ng-content", 0);
    } if (rf & 2) {
...
IosFilterComponent.ɵfac = function IosFilterComponent_Factory(t) { return new (t || IosFilterComponent)(); };
IosFilterComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: IosFilterComponent, selectors: [["ios"]], ngContentSelectors: _c1, decls: 1, vars: 1, consts: [[4, "ngIf"]], template: function IosFilterComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵtemplate(0, IosFilterComponent_ng_content_0_Template, 1, 0, "ng-content", 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngIf", ctx.show);
    } }, directives: [ɵngcc2.NgIf], encapsulation: 2 });
...
NativeScriptCommonModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NativeScriptCommonModule });
NativeScriptCommonModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NativeScriptCommonModule_Factory(t) { return new (t || NativeScriptCommonModule)(); }, providers: [ModalDialogService, defaultDeviceProvider, defaultFrameProvider, defaultPageProvider], imports: [[CommonModule], CommonModule] });
...
NativeScriptRenderer.ɵfac = function NativeScriptRenderer_Factory(t) { return new (t || NativeScriptRenderer)(ɵngcc0.ɵɵinject(undefined), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(ViewUtil)); };
NativeScriptRenderer.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NativeScriptRenderer, factory: NativeScriptRenderer.ɵfac });
...
EmulatedRenderer.ɵfac = function EmulatedRenderer_Factory(t) { return new (t || EmulatedRenderer)(ɵngcc0.ɵɵinject(undefined), ɵngcc0.ɵɵinject(undefined), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(ViewUtil)); };
EmulatedRenderer.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: EmulatedRenderer, factory: EmulatedRenderer.ɵfac });
...
NativeScriptRendererFactory.ɵfac = function NativeScriptRendererFactory_Factory(t) { return new (t || NativeScriptRendererFactory)(ɵngcc0.ɵɵinject(APP_ROOT_VIEW, 8), ɵngcc0.ɵɵinject(ɵngcc0.NgZone)); };
NativeScriptRendererFactory.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NativeScriptRendererFactory, factory: NativeScriptRendererFactory.ɵfac });
...
NativeScriptModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NativeScriptModule });
NativeScriptModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NativeScriptModule_Factory(t) { return new (t || NativeScriptModule)(ɵngcc0.ɵɵinject(NativeScriptModule, 12)); }, providers: [FrameService, NativeScriptRendererFactory, SystemJsNgModuleLoader, { provide: ɵINJECTOR_SCOPE, useValue: 'root' }, { provide: ErrorHandler, useFactory: errorHandlerFactory }, { provide: RendererFactory2, useExisting: NativeScriptRendererFactory }, { provide: ViewportScroller, useClass: ɵNullViewportScroller }], imports: [[ApplicationModule, NativeScriptCommonModule], ApplicationModule, NativeScriptCommonModule] });
...
InjectableAnimationEngine.ɵfac = function InjectableAnimationEngine_Factory(t) { return new (t || InjectableAnimationEngine)(ɵngcc0.ɵɵinject(DOCUMENT), ɵngcc0.ɵɵinject(ɵngcc3.AnimationDriver), ɵngcc0.ɵɵinject(ɵngcc3.ɵAnimationStyleNormalizer)); };
...
NsHttpBackEnd.ɵfac = function NsHttpBackEnd_Factory(t) { return new (t || NsHttpBackEnd)(ɵngcc0.ɵɵinject(ɵngcc4.XhrFactory), ɵngcc0.ɵɵinject(NSFileSystem)); };
NsHttpBackEnd.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NsHttpBackEnd, factory: NsHttpBackEnd.ɵfac });
...
NativeScriptHttpClientModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NativeScriptHttpClientModule });
NativeScriptHttpClientModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NativeScriptHttpClientModule_Factory(t) { return new (t || NativeScriptHttpClientModule)(); }, providers: [NSFileSystem, NsHttpBackEnd, { provide: HttpBackend, useExisting: NsHttpBackEnd }], imports: [[HttpClientModule], HttpClientModule] });
...
CheckedValueAccessor.ɵfac = function CheckedValueAccessor_Factory(t) { return new (t || CheckedValueAccessor)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
CheckedValueAccessor.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: CheckedValueAccessor, selectors: [["Switch", "ngModel", ""], ["Switch", "formControlName", ""], ["Switch", "formControl", ""], ["switch", "ngModel", ""], ["switch", "formControlName", ""], ["switch", "formControl", ""]], hostBindings: function CheckedValueAccessor_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("checkedChange", function CheckedValueAccessor_checkedChange_HostBindingHandler($event) { return ctx.onChange($event.value); });
...
NativeScriptFormsModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NativeScriptFormsModule });
NativeScriptFormsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NativeScriptFormsModule_Factory(t) { return new (t || NativeScriptFormsModule)(); }, providers: [], imports: [[FormsModule], FormsModule] });
...
RouterExtensions.ɵfac = function RouterExtensions_Factory(t) { return new (t || RouterExtensions)(ɵngcc0.ɵɵinject(ɵngcc5.Router), ɵngcc0.ɵɵinject(NSLocationStrategy), ɵngcc0.ɵɵinject(FrameService)); };
...
NSRouterLink.ɵfac = function NSRouterLink_Factory(t) { return new (t || NSRouterLink)(ɵngcc0.ɵɵdirectiveInject(ɵngcc5.Router), ɵngcc0.ɵɵdirectiveInject(RouterExtensions), ɵngcc0.ɵɵdirectiveInject(ɵngcc5.ActivatedRoute)); };
...
NSRouterLinkActive.ɵfac = function NSRouterLinkActive_Factory(t) { return new (t || NSRouterLinkActive)(ɵngcc0.ɵɵdirectiveInject(ɵngcc5.Router), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2)); };
NSRouterLinkActive.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: NSRouterLinkActive, selectors: [["", "nsRouterLinkActive", ""]], contentQueries: function NSRouterLinkActive_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, NSRouterLink, false);
    } if (rf & 2) {
        let _t;
...
NSRouteReuseStrategy.ɵfac = function NSRouteReuseStrategy_Factory(t) { return new (t || NSRouteReuseStrategy)(ɵngcc0.ɵɵinject(NSLocationStrategy)); };
NSRouteReuseStrategy.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NSRouteReuseStrategy, factory: NSRouteReuseStrategy.ɵfac });
...
PageRouterOutlet.ɵfac = function PageRouterOutlet_Factory(t) { return new (t || PageRouterOutlet)(ɵngcc0.ɵɵdirectiveInject(ɵngcc5.ChildrenOutletContexts), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵinjectAttribute('name'), ɵngcc0.ɵɵinjectAttribute('actionBarVisibility'), ɵngcc0.ɵɵinjectAttribute('isEmptyOutlet'), ɵngcc0.ɵɵdirectiveInject(NSLocationStrategy), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(PAGE_FACTORY), ɵngcc0.ɵɵdirectiveInject(NSRouteReuseStrategy), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(FileSystemResourceLoader, [{
        type: Injectable
    }], function () { return [{ type: NSFileSystem }]; }, null); })();
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NSLocationStrategy, [{
    ...
    }], function () { return [{ type: FrameService }]; }, null); })();
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ModalDialogService, [{
        type: Injectable
    }], function () { return [{ type: NSLocationStrategy }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TemplatedItemsComponent, [{
        type: Directive
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.IterableDiffers }]; }, { setupItemView: [{
            type: Output
        }], items: [{
            type: Input
        }], loader: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ActionBarComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc1.Page }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ActionBarScope, [{
        type: Component,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ActionItemDirective, [{
        type: Directive,
        args: [{
                selector: 'ActionItem'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ActionBarScope, decorators: [{
                type: Optional
            }] }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NavigationButtonDirective, [{
        type: Directive,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NativeScriptCommonModule, { declarations: function () { return [ListViewComponent, TemplateKeyDirective, TabViewDirective, TabViewItemDirective, ActionBarComponent, ActionBarScope, ActionItemDirective, NavigationButtonDirective, AndroidFilterComponent, IosFilterComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [CommonModule, ListViewComponent, TemplateKeyDirective, TabViewDirective, TabViewItemDirective, ActionBarComponent, ActionBarScope, ActionItemDirective, NavigationButtonDirective, AndroidFilterComponent, IosFilterComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NativeScriptCommonModule, [{
        type: NgModule,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NativeScriptRenderer, [{
        type: Injectable
    }], function () { return [{ type: undefined }, { type: ɵngcc0.NgZone }, { type: ViewUtil }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(EmulatedRenderer, [{
        type: Injectable
    }], function () { return [{ type: undefined }, { type: undefined }, { type: ɵngcc0.NgZone }, { type: ViewUtil }]; }, null); })();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NativeScriptModule, { declarations: function () { return [DetachedLoader]; }, imports: function () { return [ApplicationModule, NativeScriptCommonModule]; }, exports: function () { return [ApplicationModule, NativeScriptCommonModule, DetachedLoader]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NativeScriptModule, [{
        type: NgModule,
        args: [{
    ...
    }], function () { return [{ type: NativeScriptModule, decorators: [{
                type: Optional
            }, {
                type: SkipSelf
            }] }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(InjectableAnimationEngine, [{
        type: Injectable
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: ɵngcc3.AnimationDriver }, { type: ɵngcc3.ɵAnimationStyleNormalizer }]; }, null); })();
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NativeScriptAnimationsModule, { imports: [NativeScriptCommonModule] }); })();
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NsHttpBackEnd, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc4.XhrFactory }, { type: NSFileSystem }]; }, null); })();
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NativeScriptHttpClientModule, { imports: function () { return [HttpClientModule]; }, exports: function () { return [HttpClientModule]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NativeScriptHttpClientModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NativeScriptFormsModule, { declarations: function () { return [TextValueAccessor, CheckedValueAccessor, DateValueAccessor, TimeValueAccessor, SelectedIndexValueAccessor, NumberValueAccessor]; }, imports: function () { return [FormsModule]; }, exports: function () { return [FormsModule, TextValueAccessor, CheckedValueAccessor, DateValueAccessor, TimeValueAccessor, SelectedIndexValueAccessor, NumberValueAccessor]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NativeScriptFormsModule, [{
        type: NgModule,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(RouterExtensions, [{
    ...
    }], function () { return [{ type: ɵngcc5.Router }, { type: NSLocationStrategy }, { type: FrameService }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NSRouterLink, [{
        type: Directive,
        args: [{ selector: '[nsRouterLink]' }]
    }], function () { return [{ type: ɵngcc5.Router }, { type: RouterExtensions }, { type: ɵngcc5.ActivatedRoute }]; }, { pageTransition: [{
            type: Input
        }], params: [{
            type: Input,
            args: ['nsRouterLink']
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NSRouterLinkActive, [{
    ...
    }], function () { return [{ type: ɵngcc5.Router }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }]; }, { nsRouterLinkActiveOptions: [{
            type: Input
        }], nsRouterLinkActive: [{
            type: Input,
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PageRouterOutlet, [{
        ...
        args: [{ selector: 'page-router-outlet' }]
    }], function () { return [{ type: ɵngcc5.ChildrenOutletContexts }, { type: ɵngcc0.ViewContainerRef }, { type: String, decorators: [{
                type: Attribute,
                args: ['name']
                ...
                type: Attribute,
                args: ['isEmptyOutlet']
            }] }, { type: NSLocationStrategy }, { type: ɵngcc0.ComponentFactoryResolver }, { type: ɵngcc0.ComponentFactoryResolver }, { type: ɵngcc0.ChangeDetectorRef }, { type: undefined, decorators: [{
                type: Inject,
                args: [PAGE_FACTORY]
            }] }, { type: NSRouteReuseStrategy }, { type: ɵngcc0.NgZone }, { type: ɵngcc0.ElementRef }]; }, { activateEvents: [{
            type: Output,
            args: ['activate']
        }], deactivateEvents: [{
            type: Output,
...
NativescriptPlatformLocation.ɵfac = function NativescriptPlatformLocation_Factory(t) { return new (t || NativescriptPlatformLocation)(ɵngcc0.ɵɵinject(NSLocationStrategy)); };
NativescriptPlatformLocation.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NativescriptPlatformLocation, factory: NativescriptPlatformLocation.ɵfac });
NativescriptPlatformLocation.ctorParameters = () => [
    { type: NSLocationStrategy }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NativescriptPlatformLocation, [{
        type: Injectable
    }], function () { return [{ type: NSLocationStrategy }]; }, null); })();
...
NSEmptyOutletComponent.ɵfac = function NSEmptyOutletComponent_Factory(t) { return new (t || NSEmptyOutletComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Page)); };
NSEmptyOutletComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NSEmptyOutletComponent, selectors: [["ns-empty-outlet"]], viewQuery: function NSEmptyOutletComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(PageRouterOutlet, true, PageRouterOutlet);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.pageRouterOutlet = _t.first);
    } }, decls: 1, vars: 0, consts: [["isEmptyOutlet", "true"]], template: function NSEmptyOutletComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "page-router-outlet", 0);
    } }, directives: [PageRouterOutlet], encapsulation: 2 });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NSEmptyOutletComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc1.Page }]; }, { pageRouterOutlet: [{
            type: ViewChild,
...
NSModuleFactoryLoader.ɵfac = function NSModuleFactoryLoader_Factory(t) { return new (t || NSModuleFactoryLoader)(ɵngcc0.ɵɵinject(ɵngcc0.Compiler), ɵngcc0.ɵɵinject(ɵngcc0.SystemJsNgModuleLoaderConfig, 8)); };
NSModuleFactoryLoader.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NSModuleFactoryLoader, factory: NSModuleFactoryLoader.ɵfac });
NSModuleFactoryLoader.ctorParameters = () => [
    { type: Compiler },
    { type: SystemJsNgModuleLoaderConfig, decorators: [{ type: Optional }] }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NSModuleFactoryLoader, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc0.Compiler }, { type: ɵngcc0.SystemJsNgModuleLoaderConfig, decorators: [{
                type: Optional
            }] }]; }, null); })();
...
NativeScriptRouterModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NativeScriptRouterModule_Factory(t) { return new (t || NativeScriptRouterModule)(); }, imports: [[RouterModule, NativeScriptCommonModule], RouterModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NativeScriptRouterModule, { declarations: function () { return [NSRouterLink, NSRouterLinkActive, PageRouterOutlet, NSEmptyOutletComponent]; }, imports: function () { return [RouterModule, NativeScriptCommonModule]; }, exports: function () { return [RouterModule, NSRouterLink, NSRouterLinkActive, PageRouterOutlet, NSEmptyOutletComponent]; } }); })();
